...
function(declare, BaseWidget, map) {
    var clazz = declare([BaseWidget], {
        templateString: '<div> <br /> <br />1. Click the "Open in Google Earth" button to activate the tool. <br /> <br />' + '<br /> <input type="button" style="background-color: rgb(125,125,125)!important; background: url(./widgets/Earth/images/streetview.png) no-repeat;"  class="jimu-btn" id="btnPict" value=" &nbsp;&nbsp;&nbsp; Select" data-dojo-attach-event="click:_EarthClick"> <br /> <br /> <br />' + '2. Click on the map, and Google Earth will open for this location in a new window. To view 3D imagery where available, click and hold down on the middle mouse button or wheel and then while holding it down, move the mouse to rotate the view.<br /><br /> <img src="./widgets/Earth/images/mouse.png" width="60"><br /><br/>Note: Google Earth currently requires the <a href="http://www.chrome.com" target="_blank">Chrome browser.</a> <br /> <br /> <br /> </div> ',
        ...
        _EarthClick: function () {
            ...
            if (handlerStreetView) {
                ...
                map.setMapCursor("url(./widgets/Earth/images/streetview1.cur),auto");
