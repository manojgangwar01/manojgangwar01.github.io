...
function(
    ...
    exportUtils, ViewStack, SymbolChooser, DrawBox, Message, jimuUtils, jimuSymbolUtils,portalUtils,esriRequest
) {
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
        ...
        editorOnClickEditSaveButon: function() {            
           ...
           // var area = (wkid == 4326 || wkid == 3857 || wkid == 102100) ? geometryEngine.geodesicArea(geom, this._editorConfig["graphicCurrent"].measure.areaUnit) : geom.planarArea(geometry, this._editorConfig["graphicCurrent"].measure.areaUnit);
            ...
            //var target_url = "http://148.195.206.19/giscadexport/projectdetails/ExportProjectDetails.asp?coordinates=" + geom.rings+"&source=WebMap&txtEmailAddress=" + this.emailField.value+ "&radProjectType=external&txtProjectNumber="+this.projectField.value+ "&txtDrawingNumber="+this.drawingField.value+"&txtProjectDescription="+this.descriptionField.value+"&txtUserName="+this.nameField.value+"&txtCompanyName=No Company Name&txtUserDWGPath=D:\\GISCAD\\GISExportFiles\\DWG&txtComments="+this.commentsField.value+"&chk2=on&chk4=on&chk6=on&f=json";
            //this.showMessage("comes1");
        //     var layerRequest = esriRequest({
        //         url: "http://148.195.206.19/giscadexport/projectdetails/ExportProjectDetails.asp?coordinates=" + geom.rings,
        //         content:{
        //             username: "EEAUS\\svc_fme_server",
        //             password: "T0d@y@123",
        //             source: "WebMap",
        //             txtEmailAddress: this.emailField.value,
        //             radProjectType: "external",
        //             txtProjectNumber: this.projectField.value,
        //             txtDrawingNumber: this.drawingField.value,
        //             txtProjectDescription: this.descriptionField.value,
        //             txtUserName: this.nameField.value,
        //             txtCompanyName: "No Company Name",
        //             txtUserDWGPath: "D:\\GISCAD\\GISExportFiles\\DWG",
        //             txtComments: this.commentsField.value,
        //             chk2: "on",
        //             chk4: "on",
        //             chk6: "on",
        //             f: "json"
        ...
        //   layersRequest.then(
        //     function(response) {
        //       this.showMessage("Success: ", response.layers);
        //   }, function(error) {
        ...
        drawBoxOnDrawEnd: function(graphic, geotype, commontype) {
            ...
            this.setMode("list");
            if (parseInt(this.AreaValidation(geometry, graphic)) > 16000000 )
            {
        ...
        AreaValidation: function(geometry, graphic){
            ...
            var lengthUnit = 'METERS';//this.distanceUnitSelect.value;
            
            var esriLengthUnit = esriUnits[lengthUnit];
            
            var areaUnit = 'SQUARE_METERS';//this.areaUnitSelect.value;
            ...
            switch(geometry.type){
              ...
              case 'polygon':
                  ...
                  return  parseInt(measure.area.toFixed(1));
        ...
        onOpen: function() {
           ...
           this.email = this.portal.user.email;           
        },
